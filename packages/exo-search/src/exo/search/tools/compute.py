...
Usage:
    from examples.advanced.exo-search.tools.compute import calculate, wolfram_query
"""
...
async def wolfram_query(query: str) -> str:
    ...
    url = f"https://api.wolframalpha.com/v1/result?appid={app_id}&i={quote_plus(query)}"
