...
from orbiter.guardrail.llm_backend import LLMGuardrailBackend
...
from orbiter.guardrail.user_input import UserInputGuardrail
...
class OrderTrackingBackend(GuardrailBackend):
    ...
    def __init__(
        self, label: str, log: list[str], assessment: RiskAssessment
    ) -> None:
        self.label = label
        self.log = log
