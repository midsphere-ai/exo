...
from orbiter.retrieval.http_embeddings import HTTPEmbeddings, _get_nested
...
class TestVertexEmbeddings:
    ...
    async def test_embed_single(self) -> None:
        ...
        with patch("orbiter.retrieval.vertex_embeddings.httpx.AsyncClient", return_value=mock_client):
            e = VertexEmbeddings(api_key="token", project="my-project")
            result = await e.embed("hello")
...
class TestHTTPEmbeddings:
    ...
    async def test_embed_single(self) -> None:
        ...
        with patch("orbiter.retrieval.http_embeddings.httpx.AsyncClient", return_value=mock_client):
