...
class TestEvolve:
    ...
    async def test_no_duplicates_keeps_all(self, sample_items: list[MemoryItem]) -> None:
        strategy = ReasoningBankStrategy()
...
class TestRecall:
    ...
    async def test_recall_with_embeddings(self) -> None:
        embeddings = MockEmbeddings(
            vectors={
                "Python basics Introduction to Python Python is a programming language": [
                    1.0,
                    0.0,
                    0.0,
                ],
                "JavaScript basics Introduction to JavaScript JavaScript runs in the browser": [
                    0.0,
                    1.0,
                    0.0,
                ],
                "Rust basics Introduction to Rust Rust is a systems programming language": [
                    0.0,
                    0.0,
                    1.0,
                ],
